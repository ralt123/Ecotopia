...
int main()
{
	...
	do{
		...
		if(userChoice == 1){				
			...
			cout << "Gameplay will consist of exploring an unknown open world planet and gathering resources whilst improving your colony and your character with player upgrades, with some of which those player upgrades will consist off, upgrading your Armour, so less damage is delt with when in combat, check oxygen levels, weapon upgrades, and more. As for exploring the open world for recourses you farm you could use them to expand your colony and improve the defense from pending alien attacks.\n";
